...
public class HolderNameViewDataRepositoryTests
{
    ...
    public HolderNameViewDataRepositoryTests()
    {
        ...
        var iterator = new Mock<FeedIterator<HolderNameViewDataResponse>>();
        var readResponse = new Mock<FeedResponse<HolderNameViewDataResponse>>();
        ...
        container.Setup(mock => mock.GetItemQueryIterator<HolderNameViewDataResponse>(It.IsAny<QueryDefinition>(),
