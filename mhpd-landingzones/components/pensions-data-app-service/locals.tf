locals {
  ...
  pension_data_app_settings = {
    ...
    "PensionRetrievalServiceUrl"                            = "${local.apim_base_url}/pension-retrieval-service/"
    "RetrievedPensionsServiceUrl"                           = "${local.apim_base_url}/retrieved-pensions-record-service/"
    "tokenIntegrationServiceUrl"                            = "${local.apim_base_url}/token-integration-service/"
    "MapsCdaServiceUrl"                                     = "${local.apim_base_url}/cda-service/"
    "OpenApiServerUrl"                                      = "${local.apim_base_url}/pension-data-service/"
