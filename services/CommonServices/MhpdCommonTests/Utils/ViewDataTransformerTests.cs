...
public class ViewDataTransformerTests
{
    ...
    public void Transform_InvalidExternalAssetId_ThrowsFormatException()
    {
        ...
        Assert.Equal(PensionConstants.InvalidExternalAssetId, ex.Message);
    }
